...
<html>
<head>
    <title>Manchester City - Strona główna</title>
    <meta charset="utf-8"/>
    <meta name="keywords" content="manchester, city, manchester city, football, premier league, manchester city fc, fc"/>
    <meta name="description" content="Oficjalna strona Manchesteru City. Zobacz najnowsze informacje z życia klubu takie jak transfery, kontrakty, kontuzje i wiele więcej!"/>
...
<main>
    <section>
        <div id="winners">
            <div id="winner-dtls">
                <img id="puchar" src="img/cup.png"/>
                <a id="mistrzowie" href="news1.php">MISTRZOWIE ANGLII 21/22</a>
            </div>
        </div>
    </section>
    <section>
        <div id="space">
        <article>
            <div class="best" id="pl-month">
                <h1>ZAWODNIK MIESIĄCA!</h1>
                <img id="foden" src="img/foden.jpg"/>
            </div>
        </article>

        <article>
            <div class="best" id="pl-season">
                <h1>ZAWODNIK SEZONU!</h1>
                <img id="kdb" src="img/kdb.jpg"/>
            </div>
            <div style="clear:both;"></div>
        </article>
        </div>
        ...
        <article>
            <div id="ostatni-mecz">
                <a target="_blank" href="https://www.youtube.com/watch?v=cKeL28dPzIw"><h1>SKRÓT OSTATNIEGO MECZU</h1>
                <img id="skrot" src="img/skrot.jpg"/></a>
            </div>
        </article>
    </section>
    <section>
        <a target="_blank" href="https://www.rexona.com/pl/home.html">
            <div id="ad">
    ...
    <section>
        ...
        <a target="_blank" href="https://seasave.org/"><span id="learn-more-button">DOWIEDZ SIĘ WIĘCEJ</span></a>
    </section>
</main>
<footer>
    <div id="sponsorzy">
