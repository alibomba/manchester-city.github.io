...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/szczegoly_zamowienia.css"/>
...
<main>
    <div id="container">
        <?php
            ...
            $rezultat = $polaczenie->query("SELECT * FROM zamowienia WHERE idzamowienia = '$idzamowienia'");
            $tablica = $rezultat->fetch_assoc();


            echo '<span class="legend">Nazwa produktu:</span><br/>';
            echo '<span class="content">'.$tablica['nazwa_produktu'].'</span><br/><br/>';
            echo '<span class="legend">Imię i nazwisko:</span><br/>';
            echo '<span class="content">'.$tablica['nazwisko'].'</span><br/><br/>';
            echo '<span class="legend">Adres:</span><br/>';
            echo '<span class="content">'.$tablica['miasto'].'<br/>'.$tablica['kod_pocztowy'].'<br/>'.$tablica['adres'];
            if($tablica['nr_lokalu']!="")
            {
                echo '<br/>'.$tablica['nr_lokalu'];
            }
            echo '<br/>'.$tablica['nr_tel'].'</span><br/><br/>';
            echo '<span class="legend">Data złożenia zamówienia:</span><br/>';
            echo '<span class="content">'.$tablica['data_zlozenia'].'</span><br/><br/>';
            echo '<span class="legend">Status przesyłki:</span><br/>';
            echo '<span class="content">'.$tablica['status'].'</span><br/><br/>';
        ?>
    </div>
</main>
<footer>
