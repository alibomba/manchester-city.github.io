...
<html>
<head>
    <title>Manchester City - Obrońcy</title>
    <meta charset="utf-8"/>
...
<main>
    <section>
        <div id="jeden">
            <div class="kafelek">
                <a href="zawodnik.php?player=KYLE WALKER"><h1 class="surname">KYLE WALKER</h1></a>
                <img src="img/gracze/walker.png"/>
            </div>
            <div class="kafelek">
            <a href="zawodnik.php?player=RUBEN DIAS"><h1 class="surname">RUBEN DIAS</h1></a>
                <img src="img/gracze/dias.png"/>
            </div>
        </div>
        <div style="clear:both;"></div>
        <div id="jeden">
            <div class="kafelek">
            <a href="zawodnik.php?player=JOHN STONES"><h1 class="surname">JOHN STONES</h1></a>
                <img src="img/gracze/stones.png"/>
            </div>
            <div class="kafelek">
            <a href="zawodnik.php?player=NATHAN AKE"><h1 class="surname">NATHAN AKE</h1></a>
                <img src="img/gracze/ake.png"/>
            </div>
        </div>
        <div style="clear:both;"></div>
        <div id="jeden">
            <div class="kafelek">
            <a href="zawodnik.php?player=OLEKSANDR ZINCHENKO"><h1 class="surname">OLEKSANDR ZINCHENKO</h1></a>
                <img src="img/gracze/zinchenko.png"/>
            </div>
            <div class="kafelek">
            <a href="zawodnik.php?player=AYMERIC LAPORTE"><h1 class="surname">AYMERIC LAPORTE</h1></a>
                <img src="img/gracze/laporte.png"/>
            </div>
        </div>
        <div style="clear:both;"></div>
        <div id="dwa">
            <div class="kafelek">
            <a href="zawodnik.php?player=JOÃO CANCELO"><h1 class="surname">JOÃO CANCELO</h1></a>
                <img src="img/gracze/cancelo.png"/>
            </div>
        </div>
    </section>
</main>
