...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/kup-teraz.css"/>
...
<main>
    <section>
        <div id="container">
            <article>
                <div id="info">
                    <?php
                        ...
                        echo '<span id="nazwa-itema">NAZWA:<br/>'.$row['nazwa_produktu'].'</span>';
                        echo '<span id="cena">CENA:<br/>'.$row['cena'].' zł</span>';
                        $polaczenie->close();
                    ?>
                </div>
            </article>
            <article>
                <div id="form">
                    <form action="dodanie-zamowienia.php" method="post">
                        <label>Imię i nazwisko:<br/><input type="text" name="surname" required/></label><br/>
                        <label>Miejscowość:<br/><input type="text" name="miejscowosc" required/></label><br/>
                        <label>Kod pocztowy:<br/><input type="text" name="kod-pocztowy" required/></label><br/>
                        <label>Adres:<br/><input type="text" name="adres" required/></label><br/>
                        <label>Nr lokalu(opcjonalnie):<br/><input type="text" name="nr-lokalu"/></label><br/>
                        <label>Nr telefonu<br/><input type="text" name="nr-telefonu" required/></label><br/>
