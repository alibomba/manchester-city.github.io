...
<html>
<head>
    <title>Manchester City - Bramkarze</title>
    <meta charset="utf-8"/>
    ...
    <link rel="stylesheet" type="text/css" href="css/bramkarze.css"/>
...
<main>
    <section>
        <div id="jeden">
            <div class="kafelek">
                <a href="zawodnik.php?player=ZACK STEFFEN"><h1 class="surname">ZACK STEFFEN</h1></a>
                <img src="img/gracze/steffen.png"/>
            </div>
            <div class="kafelek">
            <a href="zawodnik.php?player=EDERSON"><h1 class="surname">EDERSON</h1></a>
                <img src="img/gracze/ederson.png"/>
            </div>
        </div>
        <div style="clear:both;"></div>
        <div id="dwa">
            <div class="kafelek">
            <a href="zawodnik.php?player=SCOTT CARSON"><h1 class="surname">SCOTT CARSON</h1></a>
                <img src="img/gracze/carson.png"/>
            </div>
        </div>
    </section>
</main>
