...
<html>
<head>
    <title>Manchester City - Kup karnet</title>
    <meta charset="utf-8"/>
...
<main>
    ...
    <section>
        <div id="container">
            <div class="mecz">
                <span>KARNET WRZESIEŃ</span><br/><br/>
                <span>ETIHAD STADIUM</span><br/><br/>
                <span>WSTĘP NA WSZYSTKIE MECZE DOMOWE MANCHESTERU CITY!</span><br/><br/><br/>
                <a href="kup-teraz.php?id=3"><span class="sprawdz-bilety">KUP TERAZ</span></a><br/><br/><br/><br/>
                <a href=""><span class="sprawdz-bilety">DODAJ DO KOSZYKA</span></a>
            </div>
        </div>
    </section>
</main>
