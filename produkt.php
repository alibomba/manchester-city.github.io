...
<main>
    <div id="container">
        <?php
            ...
            $id = $_GET['id'];
            $produkt = $polaczenie->query("SELECT * FROM produkty WHERE idproduktu='$id'");
            $row = $produkt->fetch_assoc();


            echo   '<img id="foto" src='.$row['zdj_produktu'].'/>';
            echo   '<div id="dane">';
            echo      '<div id="napisy">';
            echo          '<span>'.$row['nazwa_produktu'].'</span><br/><br/>';
            echo          '<span>'.$row['cena'].' zł</span>';
            echo   '</div>';
            echo    '<div id="przyciski">';
            echo        '<a href="dodanie-do-koszyka.php?id='.$id.'"><span>DODAJ DO KOSZYKA</span></a><br/><br/><br/><br/>';
            echo        '<a href="kup-teraz.php?id='.$id.'"><span>KUP TERAZ</span></a>';
            echo   '</div>';
            echo   '</div>';
        ?>
    </div>
