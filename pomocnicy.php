...
<html>
<head>
    <title>Manchester City - Pomocnicy</title>
    <meta charset="utf-8"/>
...
<main>
    <section>
        <div id="jeden">
            <div class="kafelek">
                <a href="zawodnik.php?player=ILKAY GUNDOGAN"><h1 class="surname">ILKAY GUNDOGAN</h1></a>
                <img src="img/gracze/gundogan.png"/>
            </div>
            <div class="kafelek">
            <a href="zawodnik.php?player=RODRIGO"><h1 class="surname">RODRIGO</h1></a>
                <img src="img/gracze/rodrigo.png"/>
            </div>
        </div>
        <div style="clear:both;"></div>
        <div id="jeden">
            <div class="kafelek">
            <a href="zawodnik.php?player=KEVIN DE BRUYNE"><h1 class="surname">KEVIN DE BRYUNE</h1></a>
                <img src="img/gracze/debryune.png"/>
            </div>
            <div class="kafelek">
            <a href="zawodnik.php?player=BERNARDO SILVA"><h1 class="surname">BERNARDO SILVA</h1></a>
                <img src="img/gracze/silva.png"/>
            </div>
        </div>
        <div style="clear:both;"></div>
        <div id="jeden">
            <div class="kafelek">
            <a href="zawodnik.php?player=FERNANDINHO"><h1 class="surname">FERNANDINHO</h1></a>
                <img src="img/gracze/fernandinho.png"/>
            </div>
            <div class="kafelek">
            <a href="zawodnik.php?player=PHIL FODEN"><h1 class="surname">PHIL FODEN</h1></a>
                <img src="img/gracze/foden.png"/>
            </div>
        </div>
        <div style="clear:both;"></div>
        <div id="dwa">
            <div class="kafelek">
            <a href="zawodnik.php?player=COLE PALMER"><h1 class="surname">COLE PALMER</h1></a>
                <img src="img/gracze/palmer.png"/>
            </div>
        </div>
    </section>
</main>
