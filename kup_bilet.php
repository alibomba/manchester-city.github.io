...
<html>
<head>
    <title>Manchester City - Kup bilet</title>
    <meta charset="utf-8"/>
    ...
    <link rel="stylesheet" type="text/css" href="css/kup_bilet.css"/>
...
<main>
    ...
    <section>
        <div id="container">
            <div class="mecz">
                <div class="mecz-main"><span>Manchester City</span><img src="img/city_badge.png"/><span>-</span><img src="img/america_badge.png"/><span>Club América</span><br/><br/></div>
                <span>20 LIP 19:30</span><br/><br/>
                <span>NRG STADIUM, HOUSTON, USA</span><br/><br/>
                <span>USA TOUR 2022</span><br/><br/><br/>
                <a href="kup-teraz.php?id=1"><span class="sprawdz-bilety">KUP TERAZ</span></a><br/><br/><br/><br/>
                <a href="dodanie-do-koszyka.php?id=1"><span class="sprawdz-bilety">DODAJ DO KOSZYKA</span></a>
            </div>
            <div class="mecz">
                <div class="mecz-main"><span>FC Bayern Munich</span><img src="img/bayern_badge.png"/><span>-</span><img src="img/city_badge.png"/><span>Manchester City</span><br/><br/></div>
                <span>23 LIP 18:00</span><br/><br/>
                <span>LAMBEAU FIELD, GREEN BAY, USA</span><br/><br/>
                <span>USA TOUR 2022</span><br/><br/><br/>
                <a href="kup-teraz.php?id=2"><span class="sprawdz-bilety">KUP TERAZ</span></a><br/><br/><br/><br/>
                <a href="dodanie-do-koszyka.php?id=2"><span class="sprawdz-bilety">DODAJ DO KOSZYKA</span></a>
            </div>
        </div>
    </section>
</main>
