...
<html>
<head>
    <title>Mistrzostwo Anglii zdobyte</title>
    <meta charset="utf-8"/>
...
<main>
    <section>
        ...
        <article>
            <div id="tresc">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc blandit dictum venenatis. Fusce pharetra aliquam laoreet. Phasellus sit amet arcu malesuada, fringilla dui vel, viverra quam. Vestibulum turpis turpis, porttitor at ex id, euismod pretium metus. Integer bibendum, velit non facilisis mattis, purus nisi convallis dolor, in imperdiet justo velit vel nibh. Aliquam laoreet eros non enim viverra pellentesque. Aenean consequat id justo a imperdiet. Proin consequat libero et lorem ultricies elementum. In dictum eros eu lacus vehicula pretium. Integer sit amet pretium sem.</p>
                <p>Vestibulum eu mauris eget neque condimentum malesuada id id diam. Fusce convallis facilisis metus, sed laoreet urna. Nullam elementum enim nec elit pretium, eget laoreet elit blandit. Cras scelerisque sit amet metus sed luctus. Praesent luctus ex ut massa porta, ut tempus ante eleifend. Quisque non sollicitudin nibh. Ut aliquam nulla nec massa ornare, at pellentesque mi mollis. Fusce eget facilisis enim, in egestas ante. Aliquam sit amet turpis eros. Sed orci nisl, maximus vel porttitor sed, accumsan vitae lacus. Proin faucibus urna non felis fermentum scelerisque. In scelerisque neque vel massa suscipit, a accumsan lorem dapibus. Duis convallis erat eu orci facilisis porttitor. Nam eu nulla lorem. Nulla ultricies diam nisl, nec auctor erat consectetur vel.</p>
                <p>Vivamus dapibus mattis ullamcorper. In nec elit interdum, faucibus ex vel, hendrerit nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur luctus leo at nulla varius, id fermentum nulla accumsan. Quisque consectetur viverra ante, eu auctor velit feugiat sed. Nam ornare vestibulum tortor sed congue. Nunc ullamcorper egestas quam in hendrerit. Aliquam gravida varius bibendum. Curabitur sollicitudin maximus turpis, sed feugiat mi malesuada nec. Duis quis vestibulum tortor. Etiam commodo lacinia augue ac interdum. Mauris nibh mi, gravida eget tincidunt sit amet, mollis at odio. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <p>Vivamus at nisi dolor. Donec hendrerit elit sed urna fermentum, in fermentum lorem maximus. Nunc quis mattis nunc, at convallis risus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed non mattis est, eget ultrices arcu. Vestibulum ullamcorper eleifend orci ac iaculis. Donec lacinia, mauris vitae facilisis cursus, arcu nulla vehicula dolor, nec aliquet ante quam rhoncus sem.</p>
                <p>Cras sit amet leo non massa convallis laoreet. Donec lobortis metus quis nulla posuere blandit. Nullam venenatis porta lacus porttitor viverra. Morbi blandit nunc sed molestie pharetra. Fusce viverra arcu sed dolor dignissim mollis. Nulla pellentesque id mauris a semper. Mauris vel eleifend lacus, et maximus urna. Maecenas facilisis, urna sit amet mollis venenatis, magna eros cursus turpis, vitae rutrum nibh risus malesuada nibh. Vivamus laoreet porttitor nulla sit amet dictum. Suspendisse id luctus felis. Cras lacus nisi, dictum id elementum eu, pretium vitae risus.</p>
            </div>
        </article>
    </section>
    <section>
        <div id="sekcja-komentarzy">
            <div id="napisz-komentarz">
                <form method="post">
                    <textarea id="pole-do-wpisania" name="komentarz" rows="3" cols="100" maxlength="300" placeholder="Napisz komentarz..." required></textarea>
                    <br/>
                    <?php
                        if(isset($_SESSION['zalogowany']))
                        {
                        ...
                        {
                            echo '<a href="ekran-logowania.php"><input type="button" value="Skomentuj"/></a>';
                        }
                    ?>
                ...
                <?php
                    ...
                    {
                        $autor = $_SESSION['login_zalogowanego'];
                        ...
                        {
                            if($dodanie_komentarza = $polaczenie->query("INSERT INTO komentarze_1 VALUES (NULL, '$autor', now(), '$tresc')"))
            ...
            <div id="komentarze">
                ...
                //tutaj jak zrobisz usuwanie komentarzy i bedzie komunikat ze komentarz nie istnieje to przed komentarzem daj if(isset(zmienne z bazy))
                    for($i = 0; $i<$liczba_komentarzy; $i++)
                    {
                        ...
                        $godzina_wstawienia = new DateTime($row['godzina']);

                        echo '<div id="komentarz">';
                        echo     '<span id="autor">'.$row['autor'].'</span>';
                        echo     '<span id="godzina">'.$godzina_wstawienia->format('H:i d.m.Y').'</span><br/>';
                        echo     '<span id="tresc-koma">'.$row['tresc'].'</span>';                   
                        echo '</div>';
